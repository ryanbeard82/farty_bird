...
GAME_SPEED = .75
FPS = 60
HIGH_SCORE_FILE = os.path.join(resource_path("assets"),"high_scores.dat")
...
# Load Images
POWERUP_AVIALABLE = [
    pygame.image.load(os.path.join(resource_path("assets"),"powerupa1.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"powerupa2.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"powerupa3.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"powerupa4.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"powerupa5.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"powerupa6.png")).convert_alpha()
]
POWERUP_COLLIDE = [
    pygame.image.load(os.path.join(resource_path("assets"),"powerupb1.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"powerupb2.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"powerupb3.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"powerupb4.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"powerupb5.png")).convert_alpha()
]
BUTT_FLY_ALIVE = [
    pygame.image.load(os.path.join(resource_path("assets"),"static.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"flap1.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"flap2.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"flap3.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"flap4.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"flap5.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"flap6.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"flap7.png")).convert_alpha()
]
BUTT_FLY_DEAD = [
    pygame.image.load(os.path.join(resource_path("assets"),"death1.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"death2.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"death3.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"death4.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"death5.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"death6.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"death7.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"death8.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"death9.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"death10.png")).convert_alpha()
]
BULLET = [
    pygame.image.load(os.path.join(resource_path("assets"),"bullet1.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"bullet2.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"bullet3.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"bullet4.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"bullet5.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"bullet6.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"bullet7.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"bullet8.png")).convert_alpha()
]
FLAPPING_BIRD = [
    pygame.image.load(os.path.join(resource_path("assets"),"flap1bird.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"flap2bird.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"flap3bird.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"flap4bird.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"flap5bird.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"flap6bird.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"flap7bird.png")).convert_alpha()
    ]
FLAPPING_FARTS = [
    pygame.image.load(os.path.join(resource_path("assets"),"flap1fart.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"flap2fart.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"flap3fart.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"flap4fart.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"flap5fart.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"flap6fart.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"flap7bird.png")).convert_alpha()
    ]
INTRO_FOG_ANIMATE = [
    pygame.image.load(os.path.join(resource_path("assets"),"fog_animate1.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"fog_animate2.png")).convert_alpha(),
    pygame.image.load(os.path.join(resource_path("assets"),"fog_animate3.png")).convert_alpha()
]
INTRO_FOG = pygame.image.load(os.path.join(resource_path("assets"),"fog.png")).convert_alpha()
INTRO_BIRD = pygame.image.load(os.path.join(resource_path("assets"),"bird.png")).convert_alpha()
INTRO_RAYS = pygame.image.load(os.path.join(resource_path("assets"),"rays.png")).convert_alpha()
INTRO_TITLE = pygame.image.load(os.path.join(resource_path("assets"),"title.png")).convert_alpha()
BG = pygame.image.load(os.path.join(resource_path("assets"),"bg_3.png")).convert()
BG_MID = pygame.image.load(os.path.join(resource_path("assets"),"bg_2.png")).convert_alpha()
BG_TOP = pygame.image.load(os.path.join(resource_path("assets"),"bg_1.png")).convert_alpha()
STATIC_BIRD = pygame.image.load(os.path.join(resource_path("assets"),"staticbird.png")).convert_alpha()
DEAD_BIRD = pygame.image.load(os.path.join(resource_path("assets"), "death.png")).convert_alpha()
FINGER_PIC = pygame.image.load(os.path.join(resource_path("assets"),"finger.png")).convert_alpha()
TURD_STREAKER_PIC = pygame.image.load(os.path.join(resource_path("assets"),"turd_streaker.png")).convert_alpha()
...
# Load Audio Fx
HIGH_FART_FX = [
    pygame.mixer.Sound(os.path.join(resource_path("assets"),"fart_1.wav")),
    pygame.mixer.Sound(os.path.join(resource_path("assets"),"fart_3.wav"))
    ]
LOW_FART_FX = [
    pygame.mixer.Sound(os.path.join(resource_path("assets"),"fart_2.wav")),
    pygame.mixer.Sound(os.path.join(resource_path("assets"),"fart_4.wav")),
    pygame.mixer.Sound(os.path.join(resource_path("assets"),"fart_5.wav")),
    ]
SHOOT_FX = pygame.mixer.Sound(os.path.join(resource_path("assets"),"shoot.wav"))
FINGER_HIT_FX = pygame.mixer.Sound(os.path.join(resource_path("assets"),"finger_hit.wav"))
BUTTFLY_HIT_FX = pygame.mixer.Sound(os.path.join(resource_path("assets"),"buttfly_hit.wav"))
RELOAD_FX = pygame.mixer.Sound(os.path.join(resource_path("assets"),"reload.wav"))
BUTT_BUZZ_FX = pygame.mixer.Sound(os.path.join(resource_path("assets"),"buzz.wav"))
POWERUP_FX = pygame.mixer.Sound(os.path.join(resource_path("assets"),"powerup.wav"))
POWERUP_FX.set_volume(.3)
TURD_HIT_FX = pygame.mixer.Sound(os.path.join(resource_path("assets"),"turd_pop.wav"))
TURD_WEE_FX = pygame.mixer.Sound(os.path.join(resource_path("assets"),"turd_wee.wav"))
INTERFACE_FX = pygame.mixer.Sound(os.path.join(resource_path("assets"),"interface.wav"))
...
class ScoreNotifcation(GameObject):
    def __init__(self, x, y):
        ...
        self.alpha = 255
        self.velocity = 3
        self.font = pygame.font.Font(os.path.join(resource_path("assets"),"ConnectionSerif.otf"), 25)
...
def play_endgame_music(): #initiates endgame music
    ...
    pygame.mixer.music.load(os.path.join(resource_path("assets"),"game_over.wav"))
...
def main():
    ...
    lost_font = pygame.font.Font(os.path.join(resource_path("assets"),"ConnectionSerif.otf"), 40)
    level_font = pygame.font.Font(os.path.join(resource_path("assets"),"ConnectionSerif.otf"), 70)
    score_font = pygame.font.Font(os.path.join(resource_path("assets"),"ConnectionSerif.otf"), 25)
...
def high_score_screen():
    ...
    score_font = pygame.font.Font(os.path.join(resource_path("assets"),"ConnectionSerif.otf"),25)
    header_font = pygame.font.Font(os.path.join(resource_path("assets"),"ConnectionSerif.otf"), 70)
    high_scores = []
    clear_prompt = False
...
def main_menu():
    ...
    global GAME_SPEED
    global FPS
    menu_font = pygame.font.Font(os.path.join(resource_path("assets"),"ConnectionSerif.otf"),25)
    run = True
    clock = pygame.time.Clock()
    intro_timer = 0
    ...
    pygame.mixer_music.load(os.path.join(resource_path("assets"),"main_menu.wav"))
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE and intro_timer > 120:
                    ...
                    pygame.mixer.music.load(os.path.join(resource_path("assets"),"main_game.wav"))
                    pygame.mixer.music.play(-1)
